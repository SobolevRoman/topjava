...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void update() throws Exception {
        ...
        perform(MockMvcRequestBuilders.put(REST_URL + MEAL1_ID)
                ...
                .andExpect(status().isNoContent());
        MEAL_MATCHER.assertMatch(service.get(MEAL1_ID, UserTestData.USER_ID), updated);
    }
    ...
    void getBetweenToDate() throws Exception {
        perform(MockMvcRequestBuilders.get(
                ...
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(MEAL_TO_MATCHER.contentJson(filterMealTosDate));
    }
    ...
    void getBetweenToTime() throws Exception {
        perform(MockMvcRequestBuilders.get(
                ...
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(MEAL_TO_MATCHER.contentJson(filterMealTosTime));
    }
